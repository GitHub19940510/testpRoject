...
$(function () {
    ...
    MPicker.prototype = {
        ...
        render: function () {
            ...
            mainStr = '<div class="mPicker-main ' + _this.disy + '" data-pickerId="' + _this.pickerId + '">' + _this.options.header + '<div class="mPicker-content">' + listStr + '</div>' + _this.options.footer + '</div>';
