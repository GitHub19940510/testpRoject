    ...
    window.Framework7 = function (params) {
        ...
        var Searchbar = function (container, params) {
            ...
            s.enable = function (e) {
                function _enable() {
                    ...
                    s.container.find("input[type='search']").attr("placeholder","");
            ...
            s.disable = function () {
                var textPlaceholder = s.container.find("input[type='search']").attr("data-text");
                s.input.val('').trigger('change');
                s.container.removeClass('searchbar-active searchbar-not-empty');
                s.container.find("input[type='search']").attr("placeholder",textPlaceholder);
        ...
        app.smartSelectOpen = function (smartSelect, reLayout) {
            ...
            var searchbarHTML =   '<form class="searchbar searchbar-init" data-search-list=".smart-select-list-' + id + '" data-search-in=".item-title">' +
                                    '<div class="searchbar-input">' +
                                        '<input type="search" placeholder="' + searchbarPlaceholder + '" data-text="'+ searchbarPlaceholder +'">' +
        ...
        ************   Infinite Scroll   ************
        ...
        function handleInfiniteScroll() {
            ...
            if(scrollTop > 200){
              inf.find(".floating-button").addClass("active");
            }else{
              inf.find(".floating-button").removeClass("active");
            }
        ...
        app.attachInfiniteScroll = function (infiniteContent) {
            $(infiniteContent).on('scroll', handleInfiniteScroll).find(".infinite-scroll-preloader").show();
        };
        app.detachInfiniteScroll = function (infiniteContent) {
            $(infiniteContent).off('scroll', handleInfiniteScroll).find(".infinite-scroll-preloader").hide();;
        };
        ...
        var Picker = function (params) {
            ...
            p.initPickerCol = function (colElement, updateItems) {
                ...
                col.calcSize = function () {
                    var col_Width = parseInt(col.width);
                    if (p.params.rotateEffect) {
                        col.container.removeClass('picker-items-col-absolute');
                        if (!col_Width) col.container.css({width:''});
                    }
    ...
    window.Swiper = function (container, params) {
        ...
        var defaults = {
            ...
            onTouchStart: function (swiper, e){
              ...
              var _e = $$(e.target);
              if(_e.targetName == "INPUT"){
                _e.find("input").blur();
              }
            },
            onTouchMove: function (swiper, e){
              var _e = $$(e.target);
              console.log("onTouchMove",_e);
            },
            // onTouchMoveOpposite: function (swiper, e){
            //   console.log("onTouchMoveOpposite");
            // },
            ...
            //   console.log("onAutoplayStart");
            // },
            // onAutoplayStop: function (swiper){
            //   console.log("onAutoplayStop");
            // },
            // onLazyImageLoad: function (swiper, slide, image){
            //   console.log("onLazyImageLoad");
            // },
        ...
        for (var param in params) {
            if (typeof params[param] === 'object' && params[param] !== null && !(params[param].nodeType || params[param] === window || params[param] === document || (typeof Dom7 !== 'undefined' && params[param] instanceof Dom7) || (typeof jQuery !== 'undefined' && params[param] instanceof jQuery))) {
                ...
                if(param) originalParams[param] = params[param];
            }
        }
        for (var def in defaults) {
            if (typeof params[def] === 'undefined') {
